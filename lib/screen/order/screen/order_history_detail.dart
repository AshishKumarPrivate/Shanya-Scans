...
import 'package:healthians/deliveryBoy/screen/UserTrackingScreen.dart';
...
class UserOrderHistoryDetailScreen extends StatefulWidget {
  ...
  @override
  _UserOrderHistoryDetailScreenState createState() =>
...
class _UserOrderHistoryDetailScreenState extends State<UserOrderHistoryDetailScreen> {
  ...
  //     fcmToken = token;
  //   });
  //   print("FCM Token: $fcmToken"); // Store/send this token to your server
  // }
