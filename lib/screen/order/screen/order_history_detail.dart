...
class UserOrderHistoryDetailScreen extends StatefulWidget {
  ...
  const UserOrderHistoryDetailScreen({Key? key, required this.orderId}) : super(key: key);

  // const OrderDetailsPage({Key? key}) : super(key: key);

  @override
  State<UserOrderHistoryDetailScreen> createState() => _UserOrderHistoryDetailScreenState();
}
