...
class CellOrderListItem extends StatefulWidget {
  ...
  @override
  State<CellOrderListItem> createState() => _CellOrderListItemState();
}

class _CellOrderListItemState extends State<CellOrderListItem> {
  @override
  void initState() {
    // Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    ...
    //         return RateListServiceShimmer(); // Show shimmer effect while loading
    //       }
    //
